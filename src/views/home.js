          ...
          <div className="home-text-section">
            ...
            <div className="home-cta-buttons">
              ...
              <Link to="/meta-ads-hub" className="home-button home-button-meta">
                <span className="home-button-icon">
                  <svg viewBox="0 0 200 120" width="24" height="14" fill="none" stroke="white" strokeWidth="12" xmlns="http://www.w3.org/2000/svg">
                    <path d="M 30,60 C 30,30 50,10 70,10 C 90,10 100,30 100,60 C 100,90 90,110 70,110 C 50,110 30,90 30,60 Z" fill="white"/>
                    <path d="M 170,60 C 170,30 150,10 130,10 C 110,10 100,30 100,60 C 100,90 110,110 130,110 C 150,110 170,90 170,60 Z" fill="white"/>
                  </svg>
                </span>
                Meta Ads Atlas
              </Link>
