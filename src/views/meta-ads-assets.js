...
import './meta-ads-assets.css'

const MetaAdsAssets = (props) => {
  return (
    <div className="meta-ads-assets-container">
      <Helmet>
        <title>Assets - Meta Ads - PPC Atlas</title>
        <meta property="og:title" content="Assets - Meta Ads - PPC Atlas" />
      </Helmet>
      <Navigation />
      <div className="meta-ads-assets-hero">
        <div className="meta-ads-assets-breadcrumb">
          <span>Meta Ads</span>
          <span className="meta-ads-assets-separator">/</span>
          <span>Assets</span>
        </div>
        <h1 className="meta-ads-assets-title">Assets</h1>
        <p className="meta-ads-assets-subtitle">
          Master assets strategies for Meta advertising
        </p>
      </div>
      <div className="meta-ads-assets-content">
        <div className="meta-ads-assets-wrapper">
          <section className="meta-ads-assets-section">
            <h2 className="meta-ads-assets-heading">Understanding Meta Assets</h2>
            <p className="meta-ads-assets-text">
              Meta Ads provides powerful capabilities for assets. The platform's advanced features enable advertisers to reach their target audience effectively across Facebook, Instagram, Messenger, and Audience Network. Understanding how to leverage these tools is essential for campaign success and achieving your marketing objectives.
            </p>
            <div className="meta-ads-assets-image-container">
              <img 
                src="https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=1200&h=600&fit=crop" 
                alt="Meta assets overview"
                className="meta-ads-assets-image"
              />
            </div>
          </section>

          <section className="meta-ads-assets-section">
            <h2 className="meta-ads-assets-heading">Advanced Strategies</h2>
            <p className="meta-ads-assets-text">
              Implementing advanced strategies for assets requires a deep understanding of Meta's algorithm and best practices. Focus on creating compelling campaigns that resonate with your audience while maintaining efficiency. Test different approaches systematically to identify what works best for your specific business goals and target market.
            </p>
            <div className="meta-ads-assets-highlight">
              <h3 className="meta-ads-assets-highlight-title">Key Best Practices</h3>
              <p className="meta-ads-assets-text">
          ...
          <section className="meta-ads-assets-section">
            <h2 className="meta-ads-assets-heading">Implementation Guide</h2>
            <p className="meta-ads-assets-text">
          ...
          <section className="meta-ads-assets-section">
            <h2 className="meta-ads-assets-heading">Optimization Techniques</h2>
            <p className="meta-ads-assets-text">
